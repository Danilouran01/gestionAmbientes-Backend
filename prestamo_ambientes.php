...
<body>
    ...
    <div class="parte-superior">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="../Html/editar_usuario.html">Editar usuarios</a></li>
    ...
    <div class="flex">
        <div class="botones-principales">
            <a href="./prestamo_ambientes.html" class="btn-1">Prestamo de ambientes</a>
            <a href="./prestamo_dispositivos.html" class="btn-1 btn-0">Prestamo de dispositivos</a>
        </div>
        <div class="herencia">
            <div class="buscador">
