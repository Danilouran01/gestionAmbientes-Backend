                        ...
                        ?>
                            <tr>
                                ...
                                if ($filas['id_estado_ambiente'] == 1) { ?>
                                    ...
                                    <<a class="btn btn-info bg-success" href="eliminarAmbiente.php?idAmbiente=<?php echo $filas['id_numero_ambiente']; ?>" style="color:white" onclick="return confirmacionEliminar() ">Eliminar</a></td>
