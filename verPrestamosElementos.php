        ...
        <div class="contenido">
            ...
            if (isset($_REQUEST['idprestamoDocumento']) || isset($_REQUEST['consultar'])) {
                ...
                if (isset($mostrar_prestamo_id) && $mostrar_prestamo_id->num_rows > 0) {
                    ...
                    <a class="btn btn-info bg-success" href="descargarExcelPrestamoElementos.php?cedula=<?php echo $_REQUEST['idprestamoDocumento'] ?>" style="color:white">descargar informe</a>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr data-toggle="tooltip" title="presiona el id del prestamo para mas informacion">
                                    ...
                                    <td class="text-center">
                                        <?php echo ($filas['observaciones'] != NULL) ? '<a href="VerDetallePrestamoElementos.php?idPrestamo=' . $filas['id_prestamo'] . ' ">ver</a>' : $filas['observaciones']; ?>
